...
def process_congressional_data(data_folder):
    ...
    congs_gdf = congs_gdf.to_crs(epsg=4326)  # Project to WGS84 (lat/lon)
    congs_gdf = congs_gdf[congs_gdf["GEOID"] != "09ZZ"]
    congs_gdf = congs_gdf[congs_gdf["GEOID"] != "17ZZ"]
    congs_gdf = congs_gdf[congs_gdf["GEOID"] != "33ZZ"]
