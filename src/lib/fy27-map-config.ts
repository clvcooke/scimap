...
export const FY27_GEO_LEVELS: Record<LossGeoLevel, MapGeoConfig> = {
  counties: {
    tileUrl: `${DOMAIN}/tiles_counties_budget27_v6/{z}/{x}/{y}.pbf`,
    maxZoom: 9,
  ...
  districts: {
    tileUrl: `${DOMAIN}/tiles_districts_budget27_v6/{z}/{x}/{y}.pbf`,
    maxZoom: 9,
  ...
  states: {
    tileUrl: `${DOMAIN}/tiles_states_budget27_v6/{z}/{x}/{y}.pbf`,
    maxZoom: 7,
