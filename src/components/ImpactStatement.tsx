            ...
            <Card shadow="xl" padding="lg" radius="md" withBorder
                ...
                <Flex direction="column" gap="sm">
                    ...
                    <Text size="md" c="dark" ta="left">
                        ...
                        the value invested. On Feb. 7th, 2025, the White House ordered across-the-board cuts to NIH
                        funding, which would cause economic losses and reduce jobs across the nation.
                    </Text>
                    <Button size="md">
                        See Impact
                    </Button>
