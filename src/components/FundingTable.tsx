...
function csvHeaderFor(col: ColumnDef): string {
  const groupLabel = GROUP_STYLES[col.group].label
  return groupLabel ? `${groupLabel} ${col.label}` : col.label
}
...
export default function FundingTable() {
  ...
  function handleExport() {
    ...
    downloadCsv(csv, `funding_${geoLevel}.csv`)
  }
