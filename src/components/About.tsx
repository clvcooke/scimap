    ...
    return (
        <Container size="md">
            ...
            <Accordion variant="contained" radius="md">
                ...
                {showTermGrants && <AccordionItem value="cancelled-grants">
                    <Accordion.Control>
                        <Title order={isMobile ? 4 : 3}>
                            Terminated Grants
                        </Title>
                    ...
                    <Accordion.Panel>
                        <Text ta={'left'}>
                            To track terminated grants, we use the Grant Watch database, which is based on reports from
                        ...
                        <Text ta={'left'} mt={'sm'}>
                            ...
                            well as terminated grants, we multiply direct loss values by 2.56 to account for the
                            demonstrated economic return generated by NIH funding.
                        </Text>
                    </Accordion.Panel>
                </AccordionItem>}
