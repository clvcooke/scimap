...
describe('Middleware', () => {
  it('should return default meta tags for the root path', async () => {
    ...
    expect(html).toContain(
      '<title>SCIMaP - Impacts of Federal Cuts to Science and Medical Research</title>',
    )
    expect(html).toContain(
      '<meta name="description" content="Developed by an interdisciplinary research team, this website shows how funding cuts reduce economic activity and employment nationwide">',
    )
    expect(html).toContain(
      '<meta property="og:image" content="https://data.scienceimpacts.org/preview2.png">',
    )
  })
  ...
  it('should return budget meta tags for the /fy26 path', async () => {
    ...
    expect(html).toContain(
      '<meta name="description" content="View Projected Impact of the FY2026 Budget Cuts to the NIH">',
    )
    expect(html).toContain(
      '<meta property="og:image" content="https://data.scienceimpacts.org/FY26-preview.png">',
    )
  })
  ...
  it('should return report card meta tags for a valid report card path', async () => {
    ...
    expect(html).toContain(
      '<meta property="og:image" content="https://data.scienceimpacts.org/report-cards-v6/report-card-CA-01.png">',
    )
  })
  ...
  it('should handle at-large districts correctly', async () => {
    ...
    expect(html).toContain(
      '<meta property="og:image" content="https://data.scienceimpacts.org/report-cards-v6/report-card-AL-00.png">',
    )
  })
  ...
  it('should not modify non-html responses', async () => {
    const context = mockContext('/data.json', {
